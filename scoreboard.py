...
class ScoreBoard:
    ...
    def __init__(self, ai_game):
        ...
        # Prepare the initial score, high score, level, and ships images
        self.prep_score()
    ...
    def prep_ships(self):
        ...
        self.ships = Group()
        for ship_number in range(self.stats.ships_left):  # Use stats.ships_left
            ship = Ship(self.ai_game)  # Create a new ship instance
            ship.rect.x = 10 + ship_number * ship.rect.width  # Position ships horizontally
            ship.rect.y = 10  # Fixed y position (adjust as needed)
            self.ships.add(ship)  # Add ship to the Group
